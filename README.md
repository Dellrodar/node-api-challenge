...
- Router Handlers, Routing, Deploying, and Middleware.

- [x] Describe Middleware?

- Middleware is an array of functions that get executed in the way they are introduced in the code. We write middleware to perform certain tasks, such as validating ID's.

- [x] Describe a Resource?

- The information we are passing from our API.
